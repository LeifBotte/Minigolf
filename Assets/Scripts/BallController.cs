...
public class BallController : MonoBehaviour
{
    ...
    public void getBallPos()
    {
        ...
        gameManager.arrowConfirmTime = 5; // ArrowConfirmTime wird auf 8 gesetzt
    ...
    private Vector3 nextPos()
    {
        ...
        switch (GolfHoleScript.holeCounter)
        {
            case 0:
                ...
                break;
            case 1:
                pos = new Vector3(12.653f,0.137f, -1.812f);
                break;
            case 2:
            ...
            case 7:
                ...
                break;
            case 8:
                pos = new Vector3(-7.60f, 0.1103f, -3.091f);
                break;
            case 9:
                pos = new Vector3(26.387f, 5.599f, -3.009f);
                gewonnen = true;
                break;
        }
        return pos;
